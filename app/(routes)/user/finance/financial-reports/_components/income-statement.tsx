...
export const IncomeStatement: React.FC<IncomeStatementProps> = ({
  ...
  const tabTitle = 'Income Statement'
  ...
  const reportSubtitle = `Income Statement`
  ...
  const reportEntries = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          amount:
            finance.violationFinesRevenue +
            finance.renovDemoRevenue +
            finance.carStickerRevenue +
            finance.donationsRevenue +
            finance.otherRevenue
        }
      ],
                          ...
                          {reportEntries.map(entry => (
                            <React.Fragment key={entry.category}>
                                      ...
                                      {(item.title === 'Other Revenues' ||
                                        ...
                                        <>
                                          ...
                                          <sub className='text-gray-400 hide-in-print'>
                                            (i.e.{' '}
                                            {item.title === 'Other Revenues'
                                              ? `Violation fines, renovation and demolition fees,
                                          car sticker receipts,
                                          donations`
                                              : `Representation expenses, donations`}
                                            )
                                          </sub>
                                        </>
                                      )}
                              ...
                              <TableRow className='bg-gray-100 hover:bg-gray-200'>
                                ...
                                <TableCell className='text-right font-semibold fit-table-padding'>
