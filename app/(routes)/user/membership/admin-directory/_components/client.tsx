...
export const AdminsClient: React.FC<AdminsClientProps> = ({
  ...
  const pageDescription = `Access the consolidated list of system admins and board of directors, along with their respective information.
`

  // Report Title and Descriptionv
  const reportTitle = `Admin & Board of Directors`
