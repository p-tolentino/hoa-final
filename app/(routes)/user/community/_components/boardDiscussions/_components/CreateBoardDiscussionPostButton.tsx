...
function CreateBoardDiscussionPostButton () {
  ...
  const onSubmit = async (values: PostFormValues) => {
    ...
    try {
      ...
      toast({
        title: `Board Discussion Post Created`,
      ...
      <DialogContent className='max-h-[500px] overflow-y-auto'>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <DialogHeader>
              <DialogTitle>Create Board Discussion Post</DialogTitle>
              <DialogDescription>
                Fill up the following fields to create a board discussion post.
              </DialogDescription>
            </DialogHeader>
            {/* Form Content */}
                ...
                render={({ field }) => (
                  <FormControl isRequired>
                    ...
                    <Input
                      ...
                      type='string'
                      {...field}
                      placeholder='Enter a Board Discussion Title'
                    />
                  </FormControl>
                )}
              />
                ...
                render={({ field }) => (
                  <FormControl isRequired>
                    ...
                    <FormHelperText fontSize='xs' mt={3}>
                      Select the category that applies to your post for board
...
export default CreateBoardDiscussionPostButton
