...
import BoardDiscussionPost from './_components/BoardDiscussionPost'
import CreateBoardDiscussionPostButton from './_components/CreateBoardDiscussionPostButton'
    ...
    <>
      <Card className='w-[57.8vw] h-[68vh]'>
        <Flex justifyContent='space-between'>
          <CardHeader>
            <CardTitle className='font-bold'>Board Discussions</CardTitle>
            <CardDescription>
              Create, view, and participate in discussions of Board Members.
            </CardDescription>
          </CardHeader>
          <HStack p='20px'>
            {/* Create Discussion Post Button*/}
            <CreateBoardDiscussionPostButton />
          </HStack>
        </Flex>
        <CardContent className='space-y-2'>
          <Flex justifyContent='space-between' mb='1%'>
            <Input
              ...
              w='350px'
              type='string'
              placeholder='Search by Board Discussion Title'
              borderRadius={5}
              value={searchInput}
